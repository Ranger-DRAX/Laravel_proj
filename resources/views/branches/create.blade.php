...
<div class="container py-4">
    <h1 class="mb-4 text-success">Add Branch</h1>
    <form action="{{ route('branches.store') }}" method="POST" class="bg-light p-4 rounded shadow-sm">
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="contact_info" class="form-control" value="{{ old('contact_info') }}" required>
